...
def lpt_optimized(instance, max_iterations=1000):
    job_durations = instance["jobs"]
...
def main():
    ...
    print(f"Processing {len(instances)} instances using LPT with optimization...")
    ...
    for idx, instance in enumerate(instances):
        ...
        schedule, makespan = lpt_optimized(instance)
