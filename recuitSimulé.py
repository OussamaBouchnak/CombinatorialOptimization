...
def simulated_annealing(instance, initial_temp=10000.0, cooling_rate=0.95, min_temp=1.0, max_iterations=10000):
    ...
    while temp > min_temp and iteration < max_iterations:
        ...
        # Evaluate neighbor
        neighbor_schedule, neighbor_makespan = create_schedule_from_job_order(instance, neighbor_order)
...
def main():
    ...
    print(f"Processing {len(instances)} instances using Simulated Annealing...")
    ...
    for idx, instance in enumerate(instances):
        ...
        schedule, makespan = simulated_annealing(instance)
